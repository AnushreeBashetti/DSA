#include <stdio.h>
#include<stdlib.h>
void readm(int r1,int c1, int a(*p)[10]);
void matr(int r1,int c1,int a(*p)[10]);
void mult(int r1,int c1,int r2,int c2,int a(*p)[10],int b(*p)[10],int c(*p)[10]);
void main()
{
    int *p;
